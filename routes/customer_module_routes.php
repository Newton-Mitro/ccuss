...
Route::prefix('customers')->group(function () {
    ...
    Route::prefix('kyc-profiles')->name('kyc-profiles.')->group(function () {
        Route::get('/', [KycProfileController::class, 'index'])->name('index');
        Route::post('/', [KycProfileController::class, 'store'])->name('store');

        Route::get('/{kycProfile}', [KycProfileController::class, 'show'])->name('show');
        Route::get('/{kycProfile}/edit', [KycProfileController::class, 'edit'])->name('edit');
        Route::put('/{kycProfile}', [KycProfileController::class, 'update'])->name('update');
        Route::delete('/{kycProfile}', [KycProfileController::class, 'destroy'])->name('destroy');

        // ✅ Profile-level approval flow
        Route::post('/{kycProfile}/approve', [KycProfileController::class, 'approve'])->name('approve');
        Route::post('/{kycProfile}/reject', [KycProfileController::class, 'reject'])->name('reject');
    });
});
