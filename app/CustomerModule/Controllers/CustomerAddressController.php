...
class CustomerAddressController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('customer-module/addresses/addresses_index', [
            'addresses' => $addresses,
    ...
    {
        return Inertia::render('customer-module/addresses/customer_addresses');
    }
    ...
    public function show(CustomerAddress $address): Response
    {
        ...
        return Inertia::render('customer-module/addresses/view_address_page', [
            'address' => $address,
        ]);
    }
