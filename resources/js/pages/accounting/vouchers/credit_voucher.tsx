...
export default function CreditVoucherEntry({ backUrl }: { backUrl: string }) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Create Credit / Receipt Voucher', href: '' },
    ];

    return (
        <CustomAuthLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Credit / Receipt Voucher" />

            {/* Header */}
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <HeadingSmall
                    title="Create Credit / Receipt Voucher"
                    description="Enter credit / receipt voucher details"
                />
                <button
                    type="button"
                    onClick={handleBack}
