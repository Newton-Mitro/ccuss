...
interface CashInBankSubLedgerSearchInputProps {
    onSelect: (ledger: SubLedger) => void;
    label?: string;
    placeholder?: string;
}

export const CashInBankSubLedgerSearchInput: React.FC<
    CashInBankSubLedgerSearchInputProps
> = ({ onSelect, label, placeholder = 'Cash In Bank Subledger' }) => {
