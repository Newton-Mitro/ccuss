...
interface CashInHandSubLedgerSearchInputProps {
    onSelect: (ledger: SubLedger) => void;
    label?: string;
    placeholder?: string;
}

export const CashInHandSubLedgerSearchInput: React.FC<
    CashInHandSubLedgerSearchInputProps
> = ({ onSelect, label, placeholder = 'Cash In Hand Subledger' }) => {
