...
function WithdrawalLedgerSection({
    ...
    return (
        <div className="flex flex-col gap-3 rounded-xl border bg-card">
            {/* Header */}
            <div className="border-b bg-destructive/5 px-4">
                <h2 className="pt-3 pb-2 text-base font-semibold text-card-foreground">
                    Cash Payment
                </h2>
            </div>
            <div className="flex flex-col gap-3 px-4">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-12">
                    {/* Left Card */}
                    <div className="space-y-2 rounded-lg border bg-muted/30 p-4 md:col-span-5">
                        ...
                        {selectedAccount && accountDetails ? (
                            <div className="mt-3 flex flex-col gap-2 rounded-md border bg-card px-2 py-2 text-xs">
                    ...
                    <div className="flex flex-col gap-4 md:col-span-7">
                        <div className="flex flex-col gap-4 rounded-lg border bg-muted/30 p-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="h-[110px] border bg-card p-2">
                                    {holders.length > 0 ? (
                                        <div className="grid h-full grid-cols-2 gap-2 overflow-y-auto rounded-md">
                                            {holders.map((holder) => (
                                                <div
                                                    key={holder.id}
                            ...
                            <div className="w-full">
                                ...
                                <div className="mt-2 flex w-full items-center justify-center rounded-md border border-dashed text-xs text-muted-foreground">
