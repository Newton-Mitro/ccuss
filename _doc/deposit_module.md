...
The Deposit Module handles all deposit products (savings, recurring, term deposits, shares) and their associated accounts, voucher_entries, cheques, interest accrual, penalties, and statements. Below is a step-by-step action flow.
...
2. **Open Deposit Account**
    ...
    - **Outcome:** Account is ready for deposits, withdrawals, and voucher_entries.
...
4. **Deposit / Withdrawal / Transaction**
    - **Purpose:** Record account voucher_entries such as deposits, withdrawals, transfers, interest, penalties, and cheque activities.
...
6. **Cheque Management**
    ...
    - **Outcome:** Cheque usage and stop-payments are tracked and linked to voucher_entries.
...
8. **Penalty Assessment**
    ...
    - **Outcome:** Penalties are recorded and may generate voucher_entries.

9. **Account Fees**
    - **Purpose:** Apply fees like opening, maintenance, or transaction charges.
    - **Key Fields:** `fee_type`, `amount`, `frequency`, `is_paid`.
    - **Outcome:** Fees are tracked and can be linked to voucher_entries.

10. **Account Statement**
    - **Purpose:** Generate statement entries from all voucher_entries.
    - **Key Fields:** `debit`, `credit`, `balance`, `posted_at`.
    - **Outcome:** Complete ledger for account with balances and voucher_entries.
