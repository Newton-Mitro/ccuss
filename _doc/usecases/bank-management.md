...
**Result:** Bank is available for branches, accounts, and transactions.
...
**Result:** Bank account is active and ready for transactions.
...
**Purpose:** To record deposits, withdrawals, transfers, and cheque transactions.
